...
/// Number of squres on the face of a cube
const SIZE_FACE: usize = SIZE_SIDE * SIZE_SIDE;
/// Number of face on a cube
pub const NB_FACES: usize = NB_COLORS;
/// Total number of squares on a cube
pub const SIZE_CUBE: usize = NB_FACES * SIZE_FACE;
